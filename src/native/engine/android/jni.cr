...
module Native::Android::JNI
  ...
  def self.attach_current_thread : Bool; false; end
  def self.detach_current_thread : Nil; end

  def self.find_class(name : String) : Void*; Pointer(Void).null; end
  def self.get_method_id(c : Void*, n : String, s : String) : Void*; Pointer(Void).null; end
  def self.get_static_method_id(c : Void*, n : String, s : String) : Void*; Pointer(Void).null; end
  def self.get_field_id(c : Void*, n : String, s : String) : Void*; Pointer(Void).null; end
  def self.get_static_field_id(c : Void*, n : String, s : String) : Void*; Pointer(Void).null; end
  def self.get_object_class(obj : Void*) : Void*; Pointer(Void).null; end
  def self.is_instance_of(obj : Void*, c : Void*) : Bool; false; end
  def self.new_string_utf(str : String) : Void*; Pointer(Void).null; end
  def self.get_string_utf_chars(str : Void*) : String; ""; end
  def self.new_object(c : Void*, m : Void*) : Void*; Pointer(Void).null; end
  def self.new_object_array(len : Int32, c : Void*, init : Void* = Pointer(Void).null) : Void*; Pointer(Void).null; end
  def self.set_object_array_element(a : Void*, i : Int32, v : Void*) : Nil; end
  def self.get_object_array_element(a : Void*, i : Int32) : Void*; Pointer(Void).null; end
  def self.get_array_length(a : Void*) : Int32; 0; end
  def self.new_byte_array(len : Int32) : Void*; Pointer(Void).null; end
  def self.set_byte_array_region(a : Void*, off : Int32, data : Bytes) : Nil; end
  def self.get_byte_array_region(a : Void*, off : Int32, len : Int32) : Bytes; Bytes.new(0); end
  def self.call_object_method(o : Void*, m : Void*, args : Array(Void*)? = nil) : Void*; Pointer(Void).null; end
  def self.call_boolean_method(o : Void*, m : Void*, args : Array(Void*)? = nil) : Bool; false; end
  def self.call_int_method(o : Void*, m : Void*, args : Array(Void*)? = nil) : Int32; 0; end
  def self.call_long_method(o : Void*, m : Void*, args : Array(Void*)? = nil) : Int64; 0i64; end
  def self.call_float_method(o : Void*, m : Void*, args : Array(Void*)? = nil) : Float32; 0.0f32; end
  def self.call_double_method(o : Void*, m : Void*, args : Array(Void*)? = nil) : Float64; 0.0; end
  def self.call_void_method(o : Void*, m : Void*, args : Array(Void*)? = nil) : Nil; end
  def self.call_static_object_method(c : Void*, m : Void*, args : Array(Void*)? = nil) : Void*; Pointer(Void).null; end
  def self.call_static_boolean_method(c : Void*, m : Void*, args : Array(Void*)? = nil) : Bool; false; end
  def self.call_static_int_method(c : Void*, m : Void*, args : Array(Void*)? = nil) : Int32; 0; end
  def self.call_static_long_method(c : Void*, m : Void*, args : Array(Void*)? = nil) : Int64; 0i64; end
  def self.call_static_double_method(c : Void*, m : Void*, args : Array(Void*)? = nil) : Float64; 0.0; end
  def self.call_static_void_method(c : Void*, m : Void*, args : Array(Void*)? = nil) : Nil; end
  def self.get_object_field(o : Void*, f : Void*) : Void*; Pointer(Void).null; end
  def self.get_boolean_field(o : Void*, f : Void*) : Bool; false; end
  def self.get_int_field(o : Void*, f : Void*) : Int32; 0; end
  def self.get_static_object_field(c : Void*, f : Void*) : Void*; Pointer(Void).null; end
  def self.get_static_int_field(c : Void*, f : Void*) : Int32; 0; end
  ...
  def self.get_activity_class_loader : Void*; Pointer(Void).null; end
